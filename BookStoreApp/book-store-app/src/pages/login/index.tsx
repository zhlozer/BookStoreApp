...
const Login = () => {
  const [email, setEmail] = useState(defaultStateValues.email);
  const [password, setPassword] = useState(defaultStateValues.password);
      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="max-w-md w-full px-16">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-4 flex justify-between items-center font-semibold text-sm">
              <label className="flex text-gray-500 hover:text-gray-600 cursor-pointer">
            ...
            <div className="mt-6">
              <button
                className="w-full bg-customOrange px-4 py-2 text-white rounded text-md tracking-wider transition"
                type="submit"
              >
                Login
              </button>
          ...
          <div className="text-center mt-4">
            <button
              className="w-full bg-white px-4 py-2 text-customBlue border border-customBlue rounded text-md tracking-wider"
